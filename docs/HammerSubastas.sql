-- SISTEMA DE SUBASTAS - HammerSubastas
-- Script completo: estructura + datos de prueba

IF EXISTS (SELECT name FROM sys.databases WHERE name = 'HammerSubastas')
BEGIN
    ALTER DATABASE HammerSubastas SET SINGLE_USER WITH ROLLBACK IMMEDIATE
    DROP DATABASE HammerSubastas
END
GO
